...
game_over_text, game_over_rect = create_text_and_rect("GAMEOVER KID",  RED, DARKGREEN, center=(WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2))




continue_text, continue_rect = create_text_and_rect("press any key to play again", RED, DARKGREEN,mid=(300,364))
